...
const conclusions = [
  {
    ...
    color: '#22c55e',
    speedup: '3.95×',
    highlight: 'Near-perfect efficiency, minimal code changes',
    icon: '🔀',
  },
  {
    impl: 'POSIX Pthreads',
    color: '#f97316',
    speedup: '4.04×',
    highlight: 'Best CPU speedup — static partitioning eliminates scheduling overhead',
    icon: '🧵',
  },
  {
    impl: 'MPI',
    color: '#a855f7',
    speedup: '4.02×',
    highlight: 'Identical scaling but seam artefact (RMSE=1.40) needs halo-exchange fix',
    icon: '📡',
  },
  {
    impl: 'CUDA',
  ...
  },
  {
    ...
    color: '#06b6d4',
    speedup: '18.1×',
    highlight: 'Super-linear efficiency (226%) — optimized for multi-node clusters',
    icon: '⚡',
  },
]
