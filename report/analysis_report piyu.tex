...
\begin{titlepage}
    ...
    {\large \textbf{Group Number: 42}}\\[1cm]
...
\midrule
Serial     & 79.78 & ---   & ---   & ---   & 1.00$\times$ \\
OpenMP     & 78.68 & 39.57 & 19.96 & 19.72 & 4.00$\times$ \\
POSIX      & 78.44 & 39.80 & 20.65 & 20.53 & 3.86$\times$ \\
MPI        & 80.81 & 40.39 & 20.86 & 20.16 & 3.82$\times$ \\
CUDA       & \multicolumn{4}{c}{0.0513 (Tesla T4, 16$\times$16 blocks)} & 1555$\times$ \\
Hybrid 2$\times$4 & --- & --- & --- & 4.37  & 18.3$\times$ \\
Hybrid 4$\times$2 & --- & --- & --- & 4.38  & 18.2$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
not sequential code. This is corroborated by CUDA with $1555\times$ speedup
...
\midrule
Pure OMP-4  & 1 & 4 & 4 & 19.96 & 4.00$\times$ \\
Hybrid 1$\times$4 & 1 & 4 & 4 & 4.37 & 18.3$\times$ \\
Hybrid 2$\times$2 & 2 & 2 & 4 & 4.39 & 18.2$\times$ \\
Hybrid 4$\times$1 & 4 & 1 & 4 & 4.37 & 18.3$\times$ \\
\midrule
Pure OMP-8  & 1 & 8 & 8 & 19.72 & 4.05$\times$ \\
Hybrid 1$\times$8 & 1 & 8 & 8 & 4.37 & 18.3$\times$ \\
Hybrid 2$\times$4 & 2 & 4 & 8 & 4.37 & 18.3$\times$ \\
Hybrid 4$\times$2 & 4 & 2 & 8 & 4.38 & 18.2$\times$ \\
Pure MPI-8  & 8 & 1 & 8 & 20.16 & 3.96$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Gaussian Blur ($21\!\times\!21$) & 79.78 & 0.0513 & 1555$\times$ \\
Edge Detection ($3\!\times\!3$)  & 2.17  & 0.0120 & 181$\times$ \\
Sharpen ($3\!\times\!3$)         & 0.26  & 0.0045 & 57$\times$ \\
\bottomrule
\end{tabular}
\end{table}
...
\]
Using $T_{\text{serial}} = 79.78$\,s from Table~\ref{tab:blur-timing}:

\textbf{OpenMP:}
\begin{align*}
  p=1:&\quad S = 79.78/78.68 = 1.014,\quad E = 1.014/1 = 101.4\% \\
  p=2:&\quad S = 79.78/39.57 = 2.016,\quad E = 2.016/2 = 100.8\% \\
  p=4:&\quad S = 79.78/19.96 = 3.997,\quad E = 3.997/4 = 99.9\% \\
  p=8:&\quad S = 79.78/19.72 = 4.045,\quad E = 4.045/8 = 50.6\%
\end{align*}

\textbf{POSIX:}
\begin{align*}
  p=1:&\quad S = 79.78/78.44 = 1.017,\quad E = 1.017/1 = 101.7\% \\
  p=2:&\quad S = 79.78/39.80 = 2.005,\quad E = 2.005/2 = 100.3\% \\
  p=4:&\quad S = 79.78/20.65 = 3.863,\quad E = 3.863/4 = 96.6\% \\
  p=8:&\quad S = 79.78/20.53 = 3.885,\quad E = 3.885/8 = 48.6\%
\end{align*}

\textbf{MPI:}
\begin{align*}
  p=1:&\quad S = 79.78/80.81 = 0.987,\quad E = 0.987/1 = 98.7\% \\
  p=2:&\quad S = 79.78/40.39 = 1.975,\quad E = 1.975/2 = 98.8\% \\
  p=4:&\quad S = 79.78/20.86 = 3.824,\quad E = 3.824/4 = 95.6\% \\
  p=8:&\quad S = 79.78/20.16 = 3.957,\quad E = 3.957/8 = 49.5\%
\end{align*}

\textbf{CUDA} (2560 cores):
\[
  S = 79.78/0.0513 = 1555,\quad E = 1555/2560 = 60.7\%
\]

\textbf{Hybrid 2$\times$4} (8 workers):
\[
  S = 79.78/4.37 = 18.3,\quad E = 18.3/8 = 228\%\;\text{(super-linear)}
\]
...
\begin{tabular}{lccccc}
\toprule
\textbf{Workers} & \textbf{OpenMP} & \textbf{POSIX} & \textbf{MPI} & \textbf{CUDA} & \textbf{Hybrid 2$\times$4} \\
\midrule
1 & 101.4\% & 101.7\% & 98.7\% & --- & --- \\
2 & 100.8\% & 100.3\% & 98.8\% & --- & --- \\
4 & 99.9\%  & 96.6\% & 95.6\% & --- & --- \\
8 & 50.6\%  & 48.6\%  & 49.5\% & --- & 228\% \\
2560 & --- & --- & --- & 60.7\% & --- \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
  \item OpenMP achieved the best CPU speedup of $4.00\times$ at 4 threads
        (and $4.05\times$ at 8 threads). Near perfect parallel efficiency; minimal code change
        for all cores available.
  \item \textbf{POSIX Pthreads} achieved $3.86\times$ at 4 threads.
        Fine-grained control via static partitioning and explicit thread lifecycle management.
  \item \textbf{MPI} achieved $3.82\times$ at 4 processes with comparable
        scaling, but creates the boundary-seam artefact
        (RMSE up to 1.40 for sharpen) to be rectified by halo-exchange.
  \item The best absolute speedup was from \textbf{CUDA}
        ($1555\times$ for blur, $181\times$ for edge) by exploiting 2560
  ...
  \item \textbf{Hybrid MPI+OpenMP} brought about $\approx\!18\times$ speedup
        ($4.37$\,s for blur) because of its optimized local convolution function.
        The 2P$\times$4T configuration was slightly the quickest. On multi-node
