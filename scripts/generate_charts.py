...
TIME_BLUR = {
    "Serial": [81.43] * 4,
    "OpenMP": [81.19, 40.46, 20.61, 20.58],
    "POSIX":  [81.68, 39.67, 20.16, 20.05],
    "MPI":    [80.19, 39.89, 20.24, 20.50],
}
CUDA_BLUR    = 0.0773
HYBRID_BLUR  = {"1x4": 4.63, "2x2": 4.58, "4x1": 4.78,
                "1x8": 4.78, "2x4": 4.64, "4x2": 4.49}

TIME_EDGE = {
    "Serial": [2.123] * 4,
    "OpenMP": [2.31, 1.29, 0.855, 0.76],
    "POSIX":  [2.14, 1.06, 0.519, 0.57],
    "MPI":    [2.08, 1.05, 0.533, 0.57],
}
CUDA_EDGE = 0.0121

TIME_SHARPEN = {
    "Serial": [0.263] * 4,
    "OpenMP": [0.29, 0.17, 0.099, 0.10],
    "POSIX":  [0.26, 0.13, 0.068, 0.07],
    "MPI":    [0.26, 0.13, 0.068, 0.08],
}
CUDA_SHARPEN = 0.0039
